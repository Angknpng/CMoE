...
from Models.model_rgb import Net
from Models.data_rgb import SalObjDataset, test_dataset
...
print('load data...')
dataset_train = SalObjDataset(train_image_root, train_gt_root, trainsize=opt.trainsize)
dataset_test = test_dataset(val_image_root, val_gt_root, opt.trainsize)
